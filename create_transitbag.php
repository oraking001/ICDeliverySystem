...
<div class="page-content-wrapper" id="hub_edit">
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <label class="control-label">Origin Hub</label>
                                                <select class="form-control fstdropdown-select" name="hub1" id="hub1">
 ...
 <!-- BEGIN CONTENT -->
            ...
            <!-- BEGIN QUICK SIDEBAR -->
            <form method="POST" id="print_form" action="dm_api/Transitbag/print_data" target="_blank">
...
<script src="assets/js/myjs/create_transit.js"></script>        
