                                ...
                                <div class="tab-pane fade active in">
                                        ...
                                        <form role="form" method="POST" id="hub_form">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-4 col-lc-6 col-xs-12 m-b-20">
                                                <label class="control-label">Select Driver<sup>*</sup></label>
 ...
 <!-- BEGIN CONTENT -->
            ...
            <div class="page-content-wrapper" id="hub_list_data" style="display:none;">
                    ...
                    <div class="row page-head">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="col-md-3" style="float:right;">
                                 <input type="button" name="dispatch" id="dispatch" value="Dispatch" class="btn btn-success" style="margin-top:22px;float:right;"/>
                ...
                <div class="hub-management-table">
                     <div class="col-md-12">
                        <div class="col-md-4">
                        <label class="control-label" style="margin-left:-30px;">Driver Sheet: <b><span id="bag_no"></span></b></label>
                        </div>
                     </div>
                     <br>
                     <div class="col-md-12">
                        <div class="col-md-4">
                        <label class="control-label" style="margin-left:-30px;margin-top:10px;">Driver: <b><span id="dest_hub"></span></b></label>
                        </div>
                        <div class="col-md-4">
...
<script src="assets/js/myjs/create_driver.js"></script>        
